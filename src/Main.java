...
;
        ...
        Pizza pizza = new Pizza("Vesuvio", "tomatsauce, ost, skinke og oregano", 57);
                ...
                new Pizza("Victoria", "tomatsauce, ost, skinke, ananas, champignon, løg, og oregano", 61);
                ...
                new Pizza("Le Blissola", "tomatsauce, ost, skinke, rejer og oregano", 61);
                new Pizza("Venezia", "tomatsauce, ost, skinke, bacon og oregano", 61);
                new Pizza("Mafia", "tomatsauce, ost, pepperoni, bacon, løg og oregano", 61);
    //    generatePizza(pizza, new ArrayList<>(Arrays.asList(
...
pizza.printNicely();
  ...
  //  private static void generatePizza(Pizza pizza, ArrayList<Pizza> pizzas) {
   // }
}